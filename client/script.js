...
/*
    ...
    Inside the callback function, console.log the response's data
     (in the intermediate instructions we'll come back to this function 
     and add HTML).
*/ 
const ohMy = () => {
    // YOUR CODE HERE
...
/*
    ...
    Handle the promise returned from the request with a 
    .then, which will take in a callback -- the callback function should print 
    the response.data.
...
queryBtn.addEventListener("click", queryTester);
////////////////
//INTERMEDIATE//
////////////////
// PROBLEM 9
...
/*
    ...
    create a form with one text input field and a button. T
    he input field should have a placeholder that tells the user to enter a food. 
    ...
    It should have one key-value pair. The key should be newFood (make sure to match the case 
